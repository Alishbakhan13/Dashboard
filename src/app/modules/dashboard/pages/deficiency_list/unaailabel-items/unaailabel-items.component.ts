...
@Component({
  selector: 'app-unaailabel-items',
  templateUrl: './unaailabel-items.component.html',
  styleUrls: ['./unaailabel-items.component.css']
})
export class UnaailabelItemsComponent implements OnInit {
...
genrateChart(data)
  { 
    this.zone.runOutsideAngular(() => {
      let chartPie = am4core.create("Piediv_1", am4charts.PieChart);
      chartPie.data = data;
